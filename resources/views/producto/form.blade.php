<div class="card shadow-sm" style="border: 1px solid #97ACBA; background-color: #D6EAF0;">
    <!-- Encabezado del formulario: indica si se está creando o editando -->
    <div class="card-header" style="background-color: #5D8EC6; color: #ffffff;">
      <h5 class="mb-0 text-center">
        {{ request()->routeIs('productos.create') ? __('Agregar producto') : __('Editar producto') }}
      </h5>
    </div>
    ...
    <div class="card-body" style="background-color: #FFF9F0;">
      ...
      <div class="mb-3 text-end">
        <button type="submit" class="btn btn-primary me-2"
          ...
          <!-- Icono de Guardar/Actualizar -->
          <img src="https://img.icons8.com/color/24/save--v1.png" alt="Guardar">
        </button>
        <a href="{{ url()->previous() }}" class="btn btn-secondary"
           style="background-color: #DFD3CC; color: #404E5E; border: 1px solid #97ACBA;">
          <!-- Icono de Cancelar -->
          <img src="https://img.icons8.com/color/24/long-arrow-left.png" alt="Cancelar">
        </a>
      </div>
    </div>
  </div>
